...
* **Interactive Input:** dynamic data entry with `try-except` blocks for robust error handling.
* **Type Casting:** Explicit conversion between strings and numeric types for calculations.
* **Arithmetic & Concatenation:** Mathematical operations and string formatting.
* **Dynamic Typing:** Demonstration of Python's ability to reassign variable types at runtime.
* **Visualization:** A `matplotlib` bar chart to visualize the User Budget vs. Costs.
